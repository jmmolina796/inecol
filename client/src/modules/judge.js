...
$("#webContent").on("change", "#juez-imagen", function () {
    ...
    if (!error) {
        ...
        var callback = function (info) {
            $("#juez-imagen").parent().find("img").attr("src", info.link);
            $("#juez-imagen").closest(".fl").addClass("fl-loaded").removeClass("fl-loading");
            var elementSpan = element.parent().find(".img-file span");

            $("#juez-imagen").parent().imagesLoaded().then(function () {
                var elementImage = $("#juez-imagen").parent().find("img");
                var arr = getDominantColor(elementImage);
                $("#juez-imagen").attr("data-color", arr);
            });
...
$("#webContent").on("click", "#btnNuevoJuez", function () {
    var link = "formRegistrarJueces";
...
$("#webContent").on("click", ".btnCancelJuez", function () {
