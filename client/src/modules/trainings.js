...
$("#webContent").on("click", "#btnNuevoCapacitacion", function () {
    loadingContent();
    var link = "formRegistrarCapacitaciones";
    var data = {
        comm: "async"
    };
...
$("#webContent").on("click", "#btnConsultarCapacitacion", function () {
    ...
    if (seleccionado) {
        ...
        loadingContent();
        var link = "formConsultarCapacitaciones";
        var data = {
            comm: "async",
