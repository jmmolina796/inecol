<?php
	...
	try
	{
        ...
        $peticion = $mysqli->query("CALL SP_updateProyectos('".$id_proyecto."','".$nombre."','".$descripcion."','".$fecha_inicio_inscripcion."','".$fecha_fin_inscripcion."','".$fecha_inicio."','".$fecha_fin."','".$imagen_portada."','".$color."')");
