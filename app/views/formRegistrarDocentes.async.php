<div class="form-registrar-docente cntFormPrincl cntTblEsc cntGrd">
	...
	<div class="mt-form mt-principal form-docentes">
        <input type="text" id="docente-nombre" name="nombre"  data-name="Nombre:"  maxlength="50" data-validate="/^[a-zA-ZáéíóúÁÉÍÓÚàèìòùÀÈÌÒÙñÑ\s]{3,50}$/" data-label="Se requiere como mínimo 3 letras" data-require="true" autocomplete="off" autocorrect="off" autocapitalize="on" spellcheck="false" />
		<input type="text" id="docente-ape_paterno" name="ape_paterno" data-name="Apellido paterno:" maxlength="50" data-validate="/^[a-zA-ZáéíóúÁÉÍÓÚàèìòùÀÈÌÒÙñÑ\s]{4,50}$/" data-label="Se requiere como mínimo 4 letras" data-require="true" autocomplete="off" autocorrect="off" autocapitalize="on" spellcheck="false" />
		<input type="text" id="docente-pae_materno" name="ape_materno" data-name="Apellido materno:" maxlength="50" data-validate="/^[a-zA-ZáéíóúÁÉÍÓÚàèìòùÀÈÌÒÙñÑ\s]{4,50}$/" data-label="Se requiere como mínimo 4 letras" data-require="true" autocomplete="off" autocorrect="off" autocapitalize="on" spellcheck="false" />
        ...
        <input type="password" id="docente-password" name="password" data-name="Password:"  maxlength="30" data-validate="/^[\s\S]{8,30}$/" data-label="Se requiere entre 8 y 30 caracteres" data-require="true" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" />
        ...
        <select class="sgl" id="slMunicipio" data-label="Campo requerido" data-require="true" name="id_municipio" data-name="Municipio:" disabled="disabled">
            <option value="none" disabled="disabled" selected="selected">Selcciona el municipio:</option>
        </select>
        ...
        <div id="containerTablaEscuelasAgregadas">
            <h4>Seleccione su grado y grupo de la escuela con la que se va a registrar</h4>
        ...
        <div class="form-buttons">
    		<div  class="mt-button btnCancelDocentes">Cancelar</div>
            <div data-check="div.mt-principal"  class="mt-button mt-button-blue btnAceptarDocentes">Registrar</div>
        </div>
	</div>
</div>