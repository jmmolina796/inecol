        ...
        else 
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    view("formModificarJueces",compact("id_juez","nombre_juez","ape_paterno","ape_materno","email","password","nombre_usuario","telefono","selectProyectos","proyectos_calificar","imagen","estatus","color"));
                }
            }
        }
